...
Current backend URL in `.env`: `https://auth-error-5.preview.emergentagent.com`

**Test the backend URL:**
```bash
# Test if backend is accessible
curl https://auth-error-5.preview.emergentagent.com/api/auth/me
```
...
curl -X POST https://auth-error-5.preview.emergentagent.com/api/auth/login \
