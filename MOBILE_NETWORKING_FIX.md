...
Current backend URL in `.env`: `https://qr-class-selector.preview.emergentagent.com`

**Test the backend URL:**
```bash
# Test if backend is accessible
curl https://qr-class-selector.preview.emergentagent.com/api/auth/me
```
...
curl -X POST https://qr-class-selector.preview.emergentagent.com/api/auth/login \
