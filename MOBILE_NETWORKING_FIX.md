...
Current backend URL in `.env`: `https://verify-doc-system.preview.emergentagent.com`

**Test the backend URL:**
```bash
# Test if backend is accessible
curl https://verify-doc-system.preview.emergentagent.com/api/auth/me
```
...
curl -X POST https://verify-doc-system.preview.emergentagent.com/api/auth/login \
